...
(function() {
  ...
  module.exports.add = function(req, res, next) {
	...
	return connection(function(db) {
		db.collection('lists', function(errCollection, collection) {
			collection.findOne({'_id': id, 'listItems._id':item_id}, {listItems: { $elemMatch: {_id: item_id} } }, function(err, item) {
				if (!item) {
					res.send("List not found");
					return;
				}
				...
				list_item = constrains.mergeListItemUpdates(list_item, item);
